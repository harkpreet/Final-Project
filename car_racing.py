...
pygame.display.set_caption("Dodge The Prius")
clock = pygame.time.Clock()

carImg = pygame.image.load("car1.png") #load the car image
carImg = pygame.transform.smoothscale(carImg, (50,100))
car2Img = pygame.image.load("car2.png")
car2Img = pygame.transform.scale(car2Img, (50,100))
bgImg = pygame.image.load("back2.jpg")
crash_img = pygame.image.load("crash.png")
svs = pygame.image.load("svs.png")
svs = pygame.transform.scale(svs, (400,200))
skrt = pygame.image.load("skrt.jpg")
skrt = pygame.transform.scale(skrt, (200,200))
def intro():
	...
	while intro:
		...
		message_display("DODGE THE PRIUS",75,display_width/2,display_height/2)
		gameDisplay.blit(svs,((display_width/2)-200,10))	
...
def gameloop():
	...
	while not gameExit:
		...
		gameDisplay.fill(red) #display background colour behind game
		
		gameDisplay.blit(bgImg,(bg_x1,bg_y1))
		gameDisplay.blit(bgImg,(bg_x2,bg_y2))
		gameDisplay.blit(skrt,(10,(display_height/2)-100))
		gameDisplay.blit(skrt,(display_width-200-10,(display_height/2)-100))
